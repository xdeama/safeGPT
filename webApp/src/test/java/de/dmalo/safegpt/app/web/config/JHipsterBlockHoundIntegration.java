...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("de.dmalo.safegpt.app.web.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("de.dmalo.safegpt.app.web.security.DomainUserDetailsService", "createSpringSecurityUser");

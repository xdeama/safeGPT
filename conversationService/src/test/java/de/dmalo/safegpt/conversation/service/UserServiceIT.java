...
import de.dmalo.safegpt.conversation.config.Constants;
import de.dmalo.safegpt.conversation.domain.User;
import de.dmalo.safegpt.conversation.repository.UserRepository;
import de.dmalo.safegpt.conversation.repository.search.UserSearchRepository;
import de.dmalo.safegpt.conversation.security.AuthoritiesConstants;
import de.dmalo.safegpt.conversation.service.dto.AdminUserDTO;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the de.dmalo.safegpt.conversation.repository.search test package.
     *
     * @see de.dmalo.safegpt.conversation.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
